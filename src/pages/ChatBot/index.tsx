  ...
  return (
    <div className="flex flex-col h-[calc(100svh-84px)] bg-gray-50">
      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-4 pb-[100px]">
        ...
        {isLoading && <div className="text-gray-500 italic">Digitando...</div>}
      ...
      <div className="border-t border-gray-200 p-4">
        <div className="flex items-start gap-2">
          <EditorContent
            editor={editor}
            className="flex-1 min-h-[100px] max-h-[250px] overflow-y-auto p-3 border border-gray-300 rounded-md focus:outline-none focus-visible:ring focus-visible:border-blue-400"
